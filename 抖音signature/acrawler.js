...
const jsdom = new JSDOM('<!doctype html><html><body></body></html>', {
    url: "https://www.douyin.com/aweme/v1/web/user/profile/self/?device_platform=webapp&aid=6383&channel=channel_pc_web&publish_video_strategy_type=2&source=channel_pc_web&version_code=160100&version_name=16.1.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0+(Windows+NT+6.1%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F91.0.4472.124+Safari%2F537.36&browser_online=true"
});
window = jsdom.window;
...
new window.XMLHttpRequest().__proto__.send = function () {
    var url = "https://www.douyin.com" + this._byted_url;
    console.warn(url);
    return url;
}
...
http.createServer(function(req, res){
    ...
    var target_url = req.headers.target_url;
    console.log('req header target_url: ' + target_url);

    var xhr = new window.XMLHttpRequest()
    xhr.open("GET", target_url, true)
    var signature = xhr.send();
